...
public class ShooterSubsystem extends SubsystemBase{
    ...
    //Aim & shoot
    public void autoAim(double distantToHub){
        targetMainRPM = mainFlywheelSpeed.get(distantToHub);    //調表格資料
        targetSecRPM = secFlywheelSpeed.get(distantToHub);
    ...
    public void manualShoot(){
        ...
        this.targetSecRPM = 0.0;

        setMainFlywheelRPM(targetMainRPM);
        setSecFlywheelRPM(targetSecRPM);
    }
    ...
    public void FlywheelTuning(){
        double targetMainRPM = SmartDashboard.getNumber("Tuning/Main Flywheel RPM", 0);
        double targetSecRPM = SmartDashboard.getNumber("Tuning/Sec Flywheel RPM", 0);
